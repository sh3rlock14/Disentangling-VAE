...
class VanillaVAE(BaseVAE):
    ...
    def __init__(self,
        ...
        self.final_layer = nn.Sequential(
            ...
            nn.LeakyReLU(),
            nn.Conv2d(hidden_dims[-1], out_channels=final_out_channels,
    ...
    def decode(self, z: Tensor) -> Tensor:
        """
        Maps the given laten codes
        onto the image space.
        :param z: (Tensor) Latent codes [B x D]
        :return: (Tensor) Reconstructed Images [B x C x H x W]
        """
